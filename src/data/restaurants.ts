...
export const CURATED_AREAS: Record<string, CuratedArea> = {
  ...
  sookmyung: {
    ...
    restaurants: [
      ...
      { id: 'sm_k07', name: '새마을식당 숙대입구역점',                       category: 'korean',    rating: 4.3,  reviewCount: 1350,  address: '서울 용산구 갈월동 86-8',                                  lat: 37.5444, lng: 126.9715, photoPool: PHOTO_POOLS.koreanBbq, photoUrls: [], photoUrl: '' },
      ...
      { id: 'sm_w09', name: '피자알볼로 서울용산점',                       category: 'western',   rating: 4.1,  reviewCount: 420,   address: '서울 용산구 청파동3가 85-17',                               lat: 37.5425, lng: 126.9705, photoPool: PHOTO_POOLS.pizza, photoUrls: [], photoUrl: '' },
